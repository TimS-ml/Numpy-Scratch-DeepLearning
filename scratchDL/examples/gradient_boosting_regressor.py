...
from scratchDL.utils import train_test_split, standardize, to_categorical
from scratchDL.utils import mean_squared_error, accuracy_score, Plot
from scratchDL.utils.loss import SquareLoss
from scratchDL.utils.misc import bar_widgets
from scratchDL.supervised_learning import GradientBoostingRegressor
...
def main():
    ...
    data = pd.read_csv('scratchDL/data/TempLinkoping2016.txt', sep="\t")
